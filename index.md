...
<!-- | Semana 1| Actividad |
|--------|-----------|
| Python Básico I  | <span style="background-color: #7BCCB5">LAB 1</span>: [Definicion de variables](https://colab.research.google.com/github/hernansalinas/autogrades/blob/main/Laboratorios_Taller/Lab01_python_basico01.ipynb) <br>[<span style="background-color: #D3D3D3">Libro de clase</span>](https://restrepo.github.io/ComputationalMethods/material/overview-python.html)|
|--------|-----------|
| Python Básico II  | <span style="background-color: #7BCCB5">LAB 2</span>: [Definicion de funciones y pensamiento algoritmico secuencial](https://colab.research.google.com/github/hernansalinas/autogrades/blob/main/Laboratorios_Taller/Lab02_python_basico02.ipynb) <br>[<span style="background-color: #D3D3D3">Libro de clase</span>](https://restrepo.github.io/ComputationalMethods/material/overview-python.html)| -->
...
<!-- {: .warning }
> Tener presente la fechas de entrega de cada uno de las tareas
>  `main`   [the CHANGELOG]({% link CHANGELOG.md %}) for a list of releases, new features, and bug fixes. -->
